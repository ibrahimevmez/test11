...
public class StudentPractice4 { public static void main(String[] args) throws InterruptedException {

    //URUNLERIN HAZIRLANMASI Icerisinde kahve turlerinin yer aldigi bir 'List'.
